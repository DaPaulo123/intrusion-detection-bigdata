...
from pyspark.sql.functions import col, from_json, from_unixtime, window, count, sum, when
...
CHECKPOINT_BASE  = "C:/tmp/checkpoints"
RESET_CHECKPOINTS = False  # ← đổi True khi cần reset
# ─── Cleanup checkpoints ──────────────────────────────────────────────────
...
traffic_schema = traffic_schema = StructType([
